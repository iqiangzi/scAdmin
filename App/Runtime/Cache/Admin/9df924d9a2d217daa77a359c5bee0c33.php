...
<body>
            ...
            <ul class="bjui-navbar-right">
                ...
                <li class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown">我的账户 <span class="caret"></span></a>
                    <ul class="dropdown-menu" role="menu">
                        ...
                        <li class="divider"></li>
                        <li><a href="<?php echo U('Login/loginout');?>" class="red">&nbsp;<span class="glyphicon glyphicon-off"></span> 注销登陆</a></li>
                    </ul>
                </li>
        ...
        <div id="bjui-hnav">
            ...
            <div id="bjui-hnav-navbar-box">
                <ul id="bjui-hnav-navbar">
                    ...
                    <?php if(is_array($menuList)): foreach($menuList as $key=>$v): if($v["lev"] == 1): ?><li <?php if($key == 0): ?>class="active"<?php endif; ?>><a href="javascript:;" data-toggle="slidebar"><i class="fa fa-<?php echo ($v["icon"]); ?>"></i> <?php echo ($v["title"]); ?></a>
                        <div class="items hide" data-noinit="true">

                            <?php if(is_array($menuList)): foreach($menuList as $key=>$v2): if($v2['pid'] == $v['id']): ?><ul class="menu-items" data-tit="<?php echo ($v2["title"]); ?>" data-faicon="<?php echo ($v2["icon"]); ?>">

                                    <?php if(is_array($menuList)): foreach($menuList as $key=>$v3): if($v3['pid'] == $v2['id']): ?><li><a href="<?php echo U($v3['name']);?>" data-options="{id:'link<?php echo ($v3["id"]); ?>', faicon:'<?php echo ($v3["icon"]); ?>'}"><?php echo ($v3["title"]); ?></a></li><?php endif; endforeach; endif; ?>
    ...
    <div id="bjui-container">
        ...
        <div id="bjui-navtab" class="tabsPage">
            ...
            <div id="sc-content" class="navtab-panel tabsPageContent">
