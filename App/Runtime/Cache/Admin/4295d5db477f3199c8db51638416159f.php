    ...
    <table data-toggle="tablefixed" data-width="100%" data-nowrap="true">
        ...
        <tbody>
            <?php if(is_array($userList)): foreach($userList as $key=>$v): ?><tr data-id="<?php echo ($v["id"]); ?>">
                ...
                <td>
                    <img src="<?php if($v['avator']): echo ($v["avator"]); else: ?>/Public/Admin/images/avator.png<?php endif; ?>"
                ...
                <td>
                    <button type="button" class="btn btn-blue" data-toggle="dialog" data-options="{id:'sc-authUser<?php echo ($v["id"]); ?>', url:'<?php echo U('User/auth');?>?id=<?php echo ($v["id"]); ?>', title:'用户授权'}">授权</button>
